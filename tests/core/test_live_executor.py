...
class TestLiveOrderExecutor:
    ...
    def config(self):
        ...
        return {"exchange": {"name": "binance", "default_type": "spot"}}
    ...
    def test_init_exchange_not_found(self, config):
        ...
        with patch(
            "ccxt.async_support.nonexistent_exchange",
    ...
    @pytest.mark.asyncio
    async def test_execute_live_order_success(
        self, config, sample_signal, mock_exchange
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_live_order_dict_signal(
        self, config, sample_signal_dict, mock_exchange
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_live_order_network_error(
        self, config, sample_signal, mock_exchange
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_live_order_exchange_error(
        self, config, sample_signal, mock_exchange
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_live_order_unexpected_error(
        self, config, sample_signal, mock_exchange
    ):
    ...
    async def test_create_order_kwargs_fallback(self, config, mock_exchange):
        ...
        with patch("ccxt.async_support.binance", return_value=mock_exchange):
            ...
            mock_exchange.create_order.side_effect = [
                TypeError("Positional args not supported"),
                {"id": "test_order"},
            ]
