...
class TestValidationCriteria:
    ...
    def test_evaluate_asset_pass(self):
        ...
        pass_criteria, overall_pass = criteria.evaluate_asset(primary_metrics, validation_metrics)
...
class TestCrossAssetValidator:
    ...
    def test_init_with_config(self, validation_config):
        ...
        assert validator.validation_criteria_config == validation_config['validation_criteria']
...
class TestIntegration:
    ...
    @patch('data.data_fetcher.DataFetcher')
    def test_full_validation_workflow(self, mock_data_fetcher_class_inner, mock_data_fetcher_class_outer, sample_data, validation_config):
        ...
        mock_fetcher.get_historical_data = AsyncMock(side_effect=mock_get_historical_data)
        ...
        with patch.object(validator, '_evaluate_strategy_on_asset') as mock_eval:
            ...
            assert os.path.exists(os.path.join(validation_config['output_dir'], 'cross_asset_validation_results.json'))
            assert os.path.exists(os.path.join(validation_config['output_dir'], 'cross_asset_validation_summary.json'))

    @patch('optimization.cross_asset_validation.DataFetcher')
    def test_validation_with_data_fetch_error(self, mock_data_fetcher_class, sample_data, validation_config):
        ...
        assert all(result.error_message == "API Error" for result in result.asset_results)

    def test_run_cross_asset_validation_function(self, sample_data):
        """Test the convenience function for running validation."""
        with patch('optimization.cross_asset_validation.create_cross_asset_validator') as mock_create:
            mock_validator = Mock()
...
class TestErrorHandling:
    ...
    @patch('optimization.cross_asset_validation.DataFetcher')
    @patch('data.data_fetcher.DataFetcher')
    def test_validation_with_empty_data(self, mock_data_fetcher_class_inner, mock_data_fetcher_class_outer, validation_config):
    ...
    @patch('optimization.cross_asset_validation.DataFetcher')
    @patch('data.data_fetcher.DataFetcher')
    def test_validation_with_invalid_params(self, mock_data_fetcher_class_inner, mock_data_fetcher_class_outer, validation_config, sample_data):
