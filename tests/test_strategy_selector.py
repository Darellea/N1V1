...
class TestStrategyPerformance:
    ...
    def test_calculate_sharpe_ratio(self):
        ...
        for i in range(10):
            perf.update_trade(10.0 if i % 2 == 0 else -5.0, 0.01 if i % 2 == 0 else -0.005, i % 2 == 0)
...
class TestMLBasedSelector:
    ...
    def test_select_strategy(self, mock_rsi, mock_ema):
        ...
        performances = {
            'EMACrossStrategy': perf_ema,
            'RSIStrategy': perf_rsi
        }
    ...
    def test_update_weights(self):
        ...
        assert selector.strategy_weights['StrategyA'] > selector.strategy_weights['StrategyB']
...
class TestGlobalFunctions:
    ...
    def test_update_strategy_performance_global(self, mock_get_selector):
        ...
        mock_selector.update_performance.assert_called_once_with('TestStrategy', 100.0, 0.05, True)
