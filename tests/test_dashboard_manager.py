...
from core.dashboard_manager import DashboardManager, Dashboard
...
class TestDashboardManager:
    ...
    async def test_render_dashboard(self):
        ...
        dashboard_config = {
            ...
            'title': 'Render Test',
            'panels': [
                {'id': 'panel1', 'title': 'Test Panel', 'type': 'graph'}
            ]
        }
    ...
    def test_cache_key_generation(self):
        ...
        self.manager.query_cache[cache_key1] = {'data': 'test1', 'timestamp': time.time()}
        self.manager.query_cache[cache_key2] = {'data': 'test2', 'timestamp': time.time()}
        self.manager.query_cache[cache_key3] = {'data': 'test3', 'timestamp': time.time()}
