...
class TestCaching:
    ...
    def test_load_from_cache_expired(self):
        ...
        cache_data = {
            ...
            "data": [{"timestamp": "2023-01-01T00:00:00", "open": 100, "high": 105, "low": 95, "close": 102, "volume": 1000}]
        }
    ...
    def test_migrate_legacy_dataset(self):
        ...
        legacy_data = {
            'data': [
                ...
                {'timestamp': '2023-01-01T01:00:00', 'open': 102, 'high': 107, 'low': 97, 'close': 104, 'volume': 1100}
            ],
            'metadata': {
...
class TestBackwardCompatibility:
    ...
    def test_all_public_methods_still_exist(self):
        ...
        result = asyncio.run(loader.load_historical_data([], '2023-01-01', '2023-01-02', '1h'))
